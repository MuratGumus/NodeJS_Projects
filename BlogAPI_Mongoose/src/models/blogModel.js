...
const nameSchema = new mongoose.Schema({  // Model oluşturan komut. 1. parametre modeli tanımladığım obje, 2. parametre collection ayarlarıdır.
...
//* Blog isimleri PascalCase şeklinde yazılır.
//* İkinci parametre ismindeki şemayı Birinci parametre ismindeki modele çevirme işlemidir. //Şemayı modele çevirme işlemi yapıyoruz.
